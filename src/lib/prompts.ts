...
8. SUMMARY — SHOW, DON'T TELL, AND NAME THE TARGET: 2-3 sentences that bridge the candidate's real experience to the target role. REQUIRED: the summary MUST mention the exact job title and company name from the JD in the first or second sentence — this is the single highest-impact ATS and recruiter signal. Lead with scale and impact (numbers, scope, outcomes). CRITICAL: The years-of-experience figure in the summary MUST be the candidate's TOTAL career length, NOT the tenure at their most recent employer. If the user message includes an "MANDATORY EXPERIENCE CONSTRAINT" block, you MUST use that exact number — e.g., "9+ years" not "4+ years at Amazon". Using a single-role tenure as the total experience is a critical error. Good: "Senior PM with 9+ years building AI-powered fraud prevention systems at Amazon — now bringing that depth to the [exact role title] at [Company]." NEVER write "Seeking to apply this expertise to [JD domain]" or "Looking to leverage my experience in [JD field]" — describe what you DID and let the company/role name do the targeting work. The formula: [seniority + TOTAL years + what you built/led + best metric] + [explicit mention of target role and company]. Bad: "Senior PM seeking to apply fraud prevention expertise to fintech merchant risk roles." Bad (uses single-role tenure): "Senior PM with 4+ years at Amazon." Bad (no company name): "Senior PM with 9+ years experience in AI products." Good: "Senior PM with 9+ years building AI-powered returns and fraud systems at Amazon, driving $28M+ in savings — applying for the Senior PM, Tandem role at Autodesk."

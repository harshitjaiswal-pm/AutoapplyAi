...
8. SUMMARY — SHOW, DON'T TELL. NEVER PITCH THE TARGET ROLE: 2-3 sentences describing who the candidate IS, based on what they have ACTUALLY done. The summary is NOT a cover letter. CRITICAL — NEVER write a "pitch" sentence that names the target role or target company. Forbidden patterns include: "applying for the [role] at [company]", "applying my [X] to the [role] at [company]", "bringing [X] to the [role] at [company]", "now bringing that depth to the [role] at [company]", "seeking to apply [X] to [Y]", "looking to leverage [X] for [Y]". Also NEVER name the target company anywhere in the summary — the hiring manager already knows which job you are applying for, and if the same file gets sent elsewhere, a target company name in the summary is an instant disqualifier. Lead with scale and impact (numbers, scope, outcomes) from the candidate's actual career. CRITICAL: The years-of-experience figure in the summary MUST be the candidate's TOTAL career length, NOT the tenure at their most recent employer. If the user message includes a "MANDATORY EXPERIENCE CONSTRAINT" block, you MUST use that exact number — e.g., "9+ years" not "4+ years at Amazon". The formula: [seniority + TOTAL years + what you have built/led + best metric + domain keywords from the JD used naturally]. Good: "Senior PM with 9+ years building AI-powered returns and fraud systems, driving $28M+ in savings through ML-based merchant risk models and cross-functional delivery." Good: "Senior Business Analyst with 8+ years delivering data validation, regression testing, and API integration across trading and risk systems." Bad (pitches target role): "Senior PM with 9+ years ... applying for the Senior PM, Tandem role at Autodesk." Bad (names target company): "Senior Business Analyst ... applying deep expertise to the Sr. Murex Business Analyst role at Synechron." Bad (uses single-role tenure): "Senior PM with 4+ years at Amazon." Tailoring to the JD is achieved by choosing domain vocabulary and emphasis, NOT by naming the target role or company.

...
7. AGGRESSIVE BULLET TAILORING — 3-5 BULLETS PER ROLE, HARD CAP 5: Each role MUST have between 3 and 5 bullets. The most-relevant role gets 5; second-most-relevant gets 4-5; older roles get 3. NEVER more than 5 in any single role. Generate fresh bullets that align with the JD's specific requirements while staying truthful to the candidate's actual experience. Do not just paraphrase the original — rewrite to lead with the JD-relevant angle, then preserve the original metric/outcome. Goal: every visible bullet should give a recruiter scanning the resume a reason to think "this person has done what we need."
